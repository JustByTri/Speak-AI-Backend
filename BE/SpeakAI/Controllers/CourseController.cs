...
namespace SpeakAI.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        {
            var response = await _courseService.EnrollCourseAsync(userId, courseId);
            return StatusCode((int)response.StatusCode, response);
        }
        ...
        {
            var response = await _courseService.GetEnrolledCourseDetailsAsync(enrolledCourseId);
            return StatusCode((int)response.StatusCode, response);
        }
        ...
        {
            var response = await _courseService.SubmitExerciseAsync(exerciseId, dto.UserId, dto.EarnedPoints);
            return StatusCode((int)response.StatusCode, response);
        }
        ...
        {
            var response = await _courseService.GetByEnrollcoursebyUserID(userId);
            return StatusCode((int)response.StatusCode, response);
        }
